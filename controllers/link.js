...
exports.create = (req, res) => {
    ...
    const slug = url;
    let link = new Link({title, slug, categories, url, type, medium});
    link.postedBy = req.user._id;

    //if database is saving as array, it does not mean that frontend needs to send it 
    // as array, it can send it as comma separated values too.
    ...
    link.save((err, data) => {
        ...
        res.json(data);
        // find all the users in the users table whose category
        // is in one or more incoming categories.
